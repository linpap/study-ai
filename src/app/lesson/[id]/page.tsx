  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between" style={{ maxWidth: '1400px' }}>
          <Link
            href="/"
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8" style={{ maxWidth: '1400px' }}>
        {/* Lesson Header */}
        <div className="mb-8">
        ...
        {!showQuiz ? (
          <>
            {/* Lesson Content */}
            <article
              className="prose prose-lg dark:prose-invert max-w-none w-full mb-12 bg-white dark:bg-gray-800 rounded-xl p-8 lg:p-12 shadow-sm"
